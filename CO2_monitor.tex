...
\lstinputlisting[firstline=19, lastline=37, caption={Loading the required libraries.}, label={lst:include}]%
...
\lstinputlisting[firstline=40, lastline=90, caption={Setup code.}, label={lst:setup}]%
{code/CO2_monitor.ino}
...
\lstinputlisting[firstline=92, lastline=126, caption={Main loop which is executed repeatedly.}, label={lst:main}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=128, lastline=136, caption={Function which prints data to the serial console.},label={lst:printSerial}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=138, lastline=165, caption={Function which prints data to the OLED display.}, label={lst:printOLED}]%
{code/CO2_monitor.ino} 
