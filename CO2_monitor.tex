...
\lstinputlisting[firstline=34, lastline=79, caption={Loading the required libraries.}, label={lst:include}]%
...
\lstinputlisting[firstline=81, lastline=107, caption={Prepare website.}, label={lst:prepare_website}]%
{code/CO2_monitor.ino}
...
\lstinputlisting[firstline=151, lastline=235, caption={Setup code.}, label={lst:setup}]%
{code/CO2_monitor.ino}
...
\lstinputlisting[firstline=237, lastline=281, caption={Main loop which is executed repeatedly.}, label={lst:main}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=110, lastline=118, caption={Function which prints data to the serial console.},label={lst:printSerial}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=121, lastline=148, caption={Function which prints data to the OLED display.}, label={lst:printOLED}]%
{code/CO2_monitor.ino} 
