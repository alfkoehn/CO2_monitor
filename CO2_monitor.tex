...
\lstinputlisting[firstline=34, lastline=101, caption={Loading the required libraries.}, label={lst:include}]%
...
\lstinputlisting[firstline=144, lastline=222, caption={Setup code.}, label={lst:setup}]%
{code/CO2_monitor.ino}
...
\lstinputlisting[firstline=224, lastline=265, caption={Main loop which is executed repeatedly.}, label={lst:main}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=104, lastline=112, caption={Function which prints data to the serial console.},label={lst:printSerial}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=114, lastline=141, caption={Function which prints data to the OLED display.}, label={lst:printOLED}]%
{code/CO2_monitor.ino} 
