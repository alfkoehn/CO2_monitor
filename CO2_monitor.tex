...
\lstinputlisting[firstline=425, lastline=433, caption={Function which prints data to the serial console.},label={lst:printSerial}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=436, lastline=466, caption={Function which prints data to an OLED display.}, label={lst:printOLED}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=469, lastline=509, caption={Function which prints data to an LCD display.}, label={lst:printLCD}]%
{code/CO2_monitor.ino} 
...
\lstinputlisting[firstline=512, lastline=648, caption={Function which prints smileys to the OLED display depending on the value of the \coo concentration.}, label={lst:printOLEDampel}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=651, lastline=670, caption={Function which prints a warning to the LCD display depending on the value of the \coo concentration.}, label={lst:printLCDampel}]%
{code/CO2_monitor.ino} 
...
\lstinputlisting[firstline=347, lastline=377, caption={Setup code for the SCD30.}, label={lst:SCD30setup}]%
{code/CO2_monitor.ino}
\lstinputlisting[firstline=380, lastline=422, caption={Function to perform a forced recalibration of the SCD30.}, label={lst:SCD30_FRC}]%
{code/CO2_monitor.ino}
