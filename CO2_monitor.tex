...
\lstinputlisting[firstline=21, lastline=45, caption={Loading the required libraries.}, label={lst:include}]%
...
\lstinputlisting[firstline=48, lastline=96, caption={Setup code.}, label={lst:setup}]%
{code/CO2_monitor.ino}
...
\lstinputlisting[firstline=98, lastline=131, caption={Main loop which is executed repeatedly.}, label={lst:main}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=133, lastline=141, caption={Function which prints data to the serial console.},label={lst:printSerial}]%
{code/CO2_monitor.ino} 
\lstinputlisting[firstline=143, lastline=170, caption={Function which prints data to the OLED display.}, label={lst:printOLED}]%
{code/CO2_monitor.ino} 
